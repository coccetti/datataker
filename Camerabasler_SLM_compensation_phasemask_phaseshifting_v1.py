...
from phase_in_functions import blank_screen, vertical_division, horizontal_division, \
    checkerboard_1, checkerboard_2, checkerboard_3, checkerboard_4
...
for run in range(Nrun):
    ...
    for mask in [blank_screen, vertical_division, horizontal_division, checkerboard_1, checkerboard_2, checkerboard_3, checkerboard_4]:
    #for mask in [checkerboard_4]:
        ...
        # 3 - Save the measures
        save_images_and_files(run_dir, mask_type, Mframes_reference, Mframes,
