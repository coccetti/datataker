...
Sc=64 #(px) use Sc=32 to have the size of  CIFAR-10 images
Mc=10 #magnification of the crop image
...
trainset_size=np.int(0.85*dataset_size)
testset_size=np.int(0.15*dataset_size)
